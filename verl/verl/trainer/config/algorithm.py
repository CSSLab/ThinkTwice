...
class AlgoConfig(BaseConfig):
    ...
    Args:
        ...
        reflection_selection_mode (str): Selection mode for reflection training samples.
            "wrong_first" prioritizes wrong responses (default), "fair" samples uniformly across uids.
    ...
    reflection_selection_mode: str = "wrong_first"
