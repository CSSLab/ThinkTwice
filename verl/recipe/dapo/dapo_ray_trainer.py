                ...
                if (
                    ...
                    with marked_timer("testing", timing_raw, "green"):
                        ...
                        if current_metric_f > self.best_val_metric:
                            ...
                            print(f"\n{'='*80}")
                            print(
                                f"NEW BEST MODEL: {best_metric_key}={current_metric_f:.4f} at step {self.global_steps}"
                            )
                            print(f"{'='*80}")
                ...
                if should_save_ckpt:
                    ...
                    if save_best_model and new_best_model and best_metric_value is not None:
                        self._save_best_model(
                            step=self.global_steps, metric_key=best_metric_key, metric_value=best_metric_value
                        )
