...
N=8
L=3000
NAME=grpo_math_reflection_Qwen3-4B-Instruct-2507
...
RAY_OBJECT_STORE_GB=${RAY_OBJECT_STORE_GB:-32}
...
mkdir -p "${TRAINER_DEFAULT_LOCAL_DIR}" "${RAY_TMPDIR}" "${TMPDIR}" "${WANDB_DIR}"
